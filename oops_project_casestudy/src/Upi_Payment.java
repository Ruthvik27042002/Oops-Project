...
public class Upi_Payment extends javax.swing.JFrame {
    ...
    public Upi_Payment() {
        initComponents();
        jTextField2.setText(""+Booking.amount);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Admin.Movie_seats.remove(Booking.a);
        Admin.Movie_seats.add(Booking.a, Booking.seat);
        Booking.Booking_Name.add(Booking.Name);
        Booking.Booking_movie_seats.add(Booking.seat1);
