...
public class Admin_Add_Movies extends javax.swing.JFrame {

    Admin A = new Admin();
    
    public Admin_Add_Movies() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this,"The movie is already Exists");
            count = 1;
            break;
        }
        }
        ...
        {
            A.Movie_Name.add(S1);
            A.Movie_Language.add(S2);
            A.Movie_Genre.add(S3);
            A.Movie_Duration.add(S4);
            A.Movie_Cast.add(S5);
            A.Movie_seats.add(seats);
